...
const buildBoard = () => {
  ...
  const downCampForm = new Camp(WINDOW_WIDTH / 2, WINDOW_HEIGHT, WINDOW_WIDTH / 8, Math.PI, 0, 'assets/beach2.png', 5, canvasArrow, [1, 3, 4]);
  const topCampForm = new Camp(WINDOW_WIDTH / 2, 0, WINDOW_WIDTH / 8, 0, Math.PI, 'assets/beach444.png', 6, canvasArrow, [0, 2, 4]);
